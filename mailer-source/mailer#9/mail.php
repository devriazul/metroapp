...
try { 
    ...
    /**
     * From PHP 5.6 forces when we make SSL it expects 
     * certificate file. So properly configuare certificate file.
     * 
     * If you are faling configuare, then you need to 
     * allow insecure connections via the SMTPOptions 
     * (not recommended as it defeats much of the point of 
     * using a secure transport at all)
    ...
    $mail->addAddress('tomail@gmail.com', 'muni');     // Add a recipient
    ...
    $mail->send();
    responseHandler(true, "Mail sent sucessfully.");
} catch (Exception $e) {
